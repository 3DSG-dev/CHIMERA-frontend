...
$codice = isset($_GET['codice'])?$_GET['codice']:$_POST['codice'];
	$SQL= "select \"file\", octet_length(\"file\") AS \"Size\" from \"MaterialeOggetti\" where \"CodiceOggetto\"= (SELECT \"CodiceOggetto\" FROM \"OggettiVersion\" WHERE \"Codice\" = $codice) AND \"URL\" ='$urlValue' ORDER BY \"Qualità\" LIMIT 1";
