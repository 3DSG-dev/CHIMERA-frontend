...
//$SQL= "select \"file\" from \"MaterialeVersioni\" where \"CodiceVersione\"= $codice AND \"URL\" ='$urlValue' ORDER BY \"Qualità\" ASC LIMIT 1";
//if ($qualityValue =='max' )
//	$SQL= "select \"file\" from \"MaterialeVersioni\" where \"CodiceVersione\"= $codice AND \"URL\" ='$urlValue' ORDER BY \"Qualità\" DESC LIMIT 1";
$SQL= "select " . ($soloInfoValue ? "" : "\"file\", ") . "\"LastModified\" from \"MaterialeVersioni\" where \"CodiceVersione\"= $codice AND \"URL\" ='$urlValue' ORDER BY \"Qualità\" " . ($qualityValue =='max' ? "DESC" : "ASC") . " LIMIT 1";
