...
if (($codiceOggetto!="null") && ($codiceOggetto!="") && ($codiceCampo!="null") && ($codiceCampo!="")) {
	if (($valore == "null") || ($valore == "")) {
		$SQL = "SELECT setoggettiinfoschedamulticombovalue($codiceOggetto, $codiceCampo, null)";
	} else {
		$SQL = "SELECT setoggettiinfoschedamulticombovalue($codiceOggetto, $codiceCampo, '$valore')";
	}
}
else
{
