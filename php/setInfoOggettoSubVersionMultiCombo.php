...
if (($codiceOggetto!="null") && ($codiceOggetto!="") && ($subVersion!="null") && ($subVersion!="") && ($codiceCampo!="null") && ($codiceCampo!="")) {
	if (($valore == "null") || ($valore == "")) {
		$SQL = "SELECT setoggettisubversioninfoschedamulticombovalue($codiceOggetto, $subVersion, $codiceCampo, null)";
	} else {
		$SQL = "SELECT setoggettisubversioninfoschedamulticombovalue($codiceOggetto, $subVersion, $codiceCampo, '$valore')";
	}
}
else
{
