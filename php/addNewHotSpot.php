...
$colorr = isset($_GET['colorr'])?$_GET['colorr']:$_POST['colorr'];
$colorg = isset($_GET['colorg'])?$_GET['colorg']:$_POST['colorg'];
$colorb = isset($_GET['colorb'])?$_GET['colorb']:$_POST['colorb'];
$colora = isset($_GET['colora'])?$_GET['colora']:$_POST['colora'];
$user = $_SESSION['validUserName'];

if (true) {
	$SQL = "SELECT preinitializenewhotspot('$layer0', '$layer1', '$layer2', '$layer3', '$nome', 0, $xc, $yc, $zc, $radius, $colorr, $colorg, $colorb, $colora, '$user')";
}
else
{
