...
if (($codiceOggetto!="null") && ($codiceOggetto!="") && ($subVersion!="null") && ($subVersion!="") && ($codiceCampo!="null") && ($codiceCampo!="")) {
	if (($valore == "null") || ($valore == "")) {
		$SQL = "SELECT setoggettisubversioninfoschedacombovalue($codiceOggetto, $subVersion, $codiceCampo, null)";
	} else {
		$SQL = "SELECT setoggettisubversioninfoschedacombovalue($codiceOggetto, $subVersion, $codiceCampo, $valore)";
	}
}
else
{
