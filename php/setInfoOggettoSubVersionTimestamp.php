...
if (($codiceOggetto!="null") && ($codiceOggetto!="") && ($subVersion!="null") && ($subVersion!="") && ($codiceCampo!="null") && ($codiceCampo!="")) {
	if (($valore == "null") || ($valore == "")) {
		$SQL = "SELECT setoggettisubversioninfoschedavalue($codiceOggetto, $subVersion, $codiceCampo, null)";
	} else {
		$SQL = "SELECT setoggettisubversioninfoschedavalue($codiceOggetto, $subVersion, $codiceCampo, to_timestamp('$valore', 'MM/DD/YYYY HH24:MI'))";
	}
}
else
{
